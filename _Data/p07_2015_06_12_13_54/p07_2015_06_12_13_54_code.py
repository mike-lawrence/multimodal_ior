if __name__ == '__main__':
	...
	for i in range(number_of_blocks):
		...
		if block_num<number_of_blocks:
			message_viewing_time = show_message('You have completed the block!\n\nWhen you are ready to continue the experiment, press any key.' + str())
